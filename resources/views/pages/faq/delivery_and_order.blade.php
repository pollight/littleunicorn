        ...
        <section class="breadcrumbs-wrp">
            <div class="container">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Условия заказа и доставки</li>
                </ol>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <div class="basic-text-content">
                            <h2 class="second-level-title">Условия заказа и доставки</h2>
                                ...
                                <li>
                                    ...
                                    <div class="hidden-info">
                                        ...
                                        <ul class="networks-list">
                                            <li><a href=""><img src="{{ asset('img/mastercard.svg') }}" alt=""></a></li>
                                            <li><a href=""><img src="{{ asset('img/visa.svg') }}" alt=""></a></li>
                                            <li><a href=""><img src="{{ asset('img/mir.svg') }}" alt=""></a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li>
